"""Integration tests for Browse API tools."""
import pytest
...
class TestSearchItemsIntegration:
    """Integration tests for search_items tool."""
...
class TestGetItemDetailsIntegration:
    """Integration tests for get_item_details tool."""
...
class TestGetItemsByCategoryIntegration:
    """Integration tests for get_items_by_category tool."""
