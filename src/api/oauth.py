...
class OAuthScopes:
    ...
    USER_CONSENT_SCOPES = " ".join([
        ...
        # SELL_MARKETPLACE_INSIGHTS_READONLY, 
        # SELL_FINANCES,
        ...
        # BUY_OFFER_AUCTION,
        COMMERCE_IDENTITY, 
        # COMMERCE_IDENTITY_EMAIL_READONLY, 
        # COMMERCE_IDENTITY_PHONE_READONLY,
        # COMMERCE_IDENTITY_ADDRESS_READONLY, 
        # COMMERCE_IDENTITY_NAME_READONLY,
        # COMMERCE_IDENTITY_STATUS_READONLY, 
        COMMERCE_NOTIFICATION_SUBSCRIPTION,
        COMMERCE_NOTIFICATION_SUBSCRIPTION_READONLY, 
        # COMMERCE_CATALOG_READONLY,
        COMMERCE_VERO
    ])
